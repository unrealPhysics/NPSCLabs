[e1,x1,psi1]=shootingSchrodinger(eigenvalues(1));
[e2,x2,psi2]=shootingSchrodinger(eigenvalues(2));
[e3,x3,psi3]=shootingSchrodinger(eigenvalues(3));
% [e4,x4,psi4]=shootingSchrodinger(eigenvalues(4));
